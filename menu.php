<nav class="navbar navbar-expand-lg navbar-dark bg-primary navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-secondary mr-sm-2" type="submit"> <i class="fa fa-search"></i> Buscar</button>
      <a href="formulario.php" class="btn btn-secondary my-sm-0"> <i class="fa fa-search"></i> Login</a>   
    </form>
</nav>